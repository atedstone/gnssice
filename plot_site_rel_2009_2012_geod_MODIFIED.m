...
i = find(ti == ceil(ti(1)));
% create 24h time series vector. from i, at 24h interval, to end of dataset (start of last day).
...
% AJT debugging of line 322
%             from end of first day, every 24h (86400 seconds in day), to end of dataset
pos_end = xf(i + (86400/interval):(86400/interval):end);
%             from start of first day, every 24h, to start of the last day. 
pos_start = xf(i:(86400/interval):end - (86400/interval)));
pos_diff = pos_end - pos_start * 365; % this should probably be 366 for 2012...
% xf is x position filtered
% i is the start time, which is essentially the first full day in ti
...
%% save velocity data
savefile = ([site 'vel_2009_autumn2012_UTC-2_20121116_opt.mat']);
save(savefile, 'v_24h','v_6h')
%% save xyzt data
savefile = ([site 'xyzt_2009_autumn2012_UTC-2_20121116_opt.mat']);
save(savefile, 'xyzt')
...
fixPSlinestyle('test.eps',[site '_vel_elev_2009-2012.eps']);
...
% save
print -depsc2 test.eps
fixPSlinestyle('test.eps',[site '_vel_options_2009-2012.eps']);